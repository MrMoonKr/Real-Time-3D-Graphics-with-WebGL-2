 ...
 * @property {number[]} indices 인덱스들
 * @property {number[]} vertices 위치들
 * @property {number[]} normals 노멀들
 * @property {number[]} uvs 
 * @property {number[]} colors 
 * @property {number[]} faceVertexColors 
 * @property {number[]} faceVertexUvs 
 * 
 */

/**
 * @callback onLoadHander
 * @param {PLYMesh} data
 */
    ...
    parse( data )
    {
        ...
        function postProcess( buffer )
        {
            ...
            for ( const customProperty of Object.keys( scope.customPropertyMapping ) )
            {
                ...
                {
                    geometry.setAttribute( customProperty, new Float32BufferAttribute( buffer[ customProperty ], 
        ...
        function handleElement( buffer, elementName, element, cacheEntry )
        {
            if ( elementName === 'vertex' )
            {
                ...
                if ( cacheEntry.attrR !== null && cacheEntry.attrG !== null && cacheEntry.attrB !== null )
                {
                    ...
                    buffer.colors.push( cacheEntry.attrR, cacheEntry.attrG, cacheEntry.attrB ) ;
                }
            ...
            else if ( elementName === 'face' )
            {
                ...
                if ( cacheEntry.attrR !== null && cacheEntry.attrG !== null && cacheEntry.attrB !== null )
                {
                    // _color.setRGB( element[ cacheEntry.attrR ] / 255.0,
                    //                element[ cacheEntry.attrG ] / 255.0,
                    //                element[ cacheEntry.attrB ] / 255.0 )
                    //       .convertSRGBToLinear();
